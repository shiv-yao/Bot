...
def effective_config(settings: Any) -> dict[str, Any]:
    names = [
        "mode", "auto_discover_market", "account_equity_usd", "max_order_equity_fraction",
        ...
        "signal_cooldown_ms", "paper_hold_sec", "paper_max_open_positions",
        "paper_take_profit_pct", "paper_stop_loss_pct", "paper_trailing_stop_pct",
        "paper_open_buffer_sec", "paper_close_buffer_sec", "paper_max_trades_per_market",
        "paper_max_consecutive_losses_per_market", "paper_db_path", "enable_binance_ws",
        "enable_coinbase_ws", "enable_multi_source_fusion", "fusion_min_sources",
        "fusion_agreement_threshold", "external_price_max_age_ms", "external_price_window_sec",
    ]
    output = {"mode": "paper"}
    for name in names:
        if name == "mode":
