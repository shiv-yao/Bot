...
def effective_config(settings: Any) -> dict[str, Any]:
    names = [
        ...
        "paper_disable_order_rate_limit", "paper_hold_sec", "paper_max_open_positions",
