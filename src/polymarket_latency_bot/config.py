...
class Settings(BaseSettings):
    ...
    ai_min_probability_margin: float = Field(default=0.01, ge=0, le=0.49)
    ...
    signal_cooldown_ms: int = Field(default=3000, ge=0)
    max_signal_age_ms: int = Field(default=1500, gt=0)
    strategy_evaluation_interval_ms: int = Field(default=100, ge=25, le=5000)
    ...
    paper_hold_sec: int = Field(default=45, ge=5, le=900)
    ...
    paper_open_buffer_sec: int = Field(default=10, ge=0, le=600)
    paper_close_buffer_sec: int = Field(default=35, ge=0, le=600)
    ...
    rtds_prediction_window_sec: int = Field(default=30, ge=10)
    ...
    external_price_window_sec: int = Field(default=30, ge=10, le=900)
