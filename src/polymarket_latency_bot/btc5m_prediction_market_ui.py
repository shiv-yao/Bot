...
<head>
  ...
  <title>Polymarket BTC 5m Prediction Market</title>
  <style>
...
<body>
<main class="wrap">
<header class="top"><div><div class="eyebrow">Polymarket · BTC 5 Minute</div><div class="title">BTC 5 分鐘預測市場</div><div class="sub">每輪只預測一次：YES 上漲 · NO 下跌 · WAIT 不下注</div></div><div id="systemPill" class="pill">LOADING</div></header>
<section class="grid">
  ...
  <article class="card mini"><h3>本輪預測明細</h3><div class="row"><span>BTC 開盤價</span><strong id="btcOpen">—</strong></div><div class="row"><span>BTC 收盤價</span><strong id="btcClose">—</strong></div><div class="row"><span>合約進場價</span><strong id="entryPrice">—</strong></div><div class="row"><span>模擬本金</span><strong id="notional">—</strong></div><div class="row"><span>結算結果</span><strong id="outcome">—</strong></div></article>
  <article class="card mini"><h3>規則</h3><div class="row"><span>YES</span><strong>5 分鐘後 BTC 上漲</strong></div><div class="row"><span>NO</span><strong>5 分鐘後 BTC 下跌</strong></div><div class="row"><span>WAIT</span><strong>信心不足，不下注</strong></div><div class="row"><span>每輪下注數</span><strong>最多 1 筆</strong></div><div class="row"><span>短線重複下單</span><strong>OFF</strong></div></article>
